    ...
    <div style={{minHeight:"100vh",background:"#f7f4ef",fontFamily:"Georgia,serif",color:"#1a1a1a",margin:0}}>
      ...
      {showAddForm && (
        <div style={{background:"#1a1a2e",padding:"16px 20px",borderBottom:"2px solid #c8963e"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr":"repeat(auto-fill, minmax(150px, 1fr))",gap:"10px"}}>
      ...
      {loading ? (
        ...
        /* ── MOBILE CARD VIEW ── */
        <div style={{display:"flex",flexDirection:"column",gap:"10px",padding:"10px 12px"}}>
